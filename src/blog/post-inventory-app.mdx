...
<figure>
  ...
  />
  <figcaption>
    The flow to make an order to a supplier. This include an "item matching"
    flow in order to automatically update an item when the order arrived. One of
    the complexities in this project.
  </figcaption>
</figure>
