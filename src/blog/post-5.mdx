...
<figure>
  ...
  <figcaption>
    ...
    details of selected account in the same page, which made it a hassle to scan
    for specific entry.
  </figcaption>
</figure>
...
<figure>
  ...
  />
  <figcaption>
    Redesigned General Ledger separated list of account and account details for
    better information display. The account details page also displayed end
    balance number fixed at the bottom of the page based on account team work
    preference.
  </figcaption>
</figure>
