...
<figure>
  ...
  />
  <figcaption>
    Redesigned General Ledger separated list of account page (upper left) and
    account details page (bottom right) for better information display. The
    account details page also displayed end balance number fixed at the bottom
    of the page based on account team work preference.
  </figcaption>
</figure>
